...
public class ChangePasswordFrame extends JInternalFrame {
	...
	private UserInfo user = LoginFrame.getUser();
	public ChangePasswordFrame() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				if (oldPass.getPassword().equals(user.getPass())) {
					if (newPass1.getPassword().equals(newPass2.getPassword())) {
						user.setPass(String.valueOf(newPass1.getPassword()));
						DBOper.updateUser(user);
