...
public class SaleReturnQueryFrame extends JInternalFrame {
	...
	public SaleReturnQueryFrame() {
		...
		showAllButton.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				content.setText("");
				List list=DBOper.findForList("select * from v_xsthView");
	...
	private final class QueryAction implements ActionListener {
		public void actionPerformed(final ActionEvent e) {
			...
			list = DBOper.findForList("select * from v_xsthView where "
					+ con
					+ opstr
					+ (oper == 0 ? "'"+cont+"'" : "'%" + cont + "%'")
