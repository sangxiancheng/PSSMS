...
import frame.OperatorManageFrame;
import databaseOperation.DBOper;

public class DeleteOperatorFrame extends JPanel{
	...
	public DeleteOperatorFrame() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				int op = JOptionPane.showConfirmDialog(DeleteOperatorFrame.this,
						"确认要删除该操作员？");
				if (op == JOptionPane.OK_OPTION) {
					DBOper.delete("delete tb_userlist where username='"+ loginName.getText() + "'");
					loginName.setText("");
					passField.setText("");
					userName.setText("");
					initTable();
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				OperatorManageFrame parent = (OperatorManageFrame)DeleteOperatorFrame.this.getRootPane().getParent();
				parent.doDefaultCloseAction();
			}
		});
	}
	public void initTable() {
		List ul = DBOper.getUsers();
