...
public class CustomerQueryFrame extends JInternalFrame{
			...
			if (!conditionString.isEmpty()) {
				...
				if (condition.equals("客户全称")) {
					if (conditionOperation.equals("等于"))
						list = DBOper.findForList(sql + "khname='"
								+ conditionString + "'");
					else
						list = DBOper.findForList(sql + "khname like '%"
								+ conditionString + "%'");
				} else {
					if (conditionOperation.equals("等于"))
						list = DBOper.findForList(sql + "jian='" + conditionString
								+ "'");
					else
						list = DBOper.findForList(sql + "jian like '%"
								+ conditionString + "%'");
				}
				updateTable(list, dftm);
			} else
