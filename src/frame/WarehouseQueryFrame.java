...
public class WarehouseQueryFrame extends JInternalFrame {
	...
	public WarehouseQueryFrame() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				...
				if (selectDate.isSelected()) {
					...
					list = DBOper.findForList(sql + conditionStr + " "
		...
		showallButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				content.setText("");
				List list = DBOper.findForList("select * from v_rukuView");
