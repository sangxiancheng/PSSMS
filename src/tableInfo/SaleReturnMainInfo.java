...
public class SaleReturnMainInfo implements java.io.Serializable {
	...
	public SaleReturnMainInfo() {
	}
	public SaleReturnMainInfo(String xsthId,String pzs, String je, String ysjl, String khname,String thdate, String czy, String jsr, String jsfs) {
		this.xsthId=xsthId;
		this.pzs = pzs;
		this.je = je;
		this.ysjl = ysjl;
