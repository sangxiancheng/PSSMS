...
public class WarhosRtMainInfo implements java.io.Serializable {
	...
	public WarhosRtMainInfo() {
	}
	public WarhosRtMainInfo(String rkthId, String pzs, String je, String ysjl,String gysname, String rtdate, String czy, String jsr, String jsfs) {
		this.rkthId=rkthId;
		this.pzs = pzs;
		this.je = je;
		this.ysjl = ysjl;
