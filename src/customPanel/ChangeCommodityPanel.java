...
public class ChangeCommodityPanel extends JPanel {
		...
		delButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int confirm = JOptionPane.showConfirmDialog(
						ChangeCommodityPanel.this, "确认删除商品信息吗？");
				if (confirm == JOptionPane.YES_OPTION) {
					int rs = DBOper.delete("delete tb_spinfo where id='"
							+ item.getId() + "'");
					if (rs > 0) {
						JOptionPane.showMessageDialog(ChangeCommodityPanel.this,
	...
	private void doSpSelectAction() {
		...
		CommodityInfo spInfo = DBOper.getSpInfo(selectedItem);
